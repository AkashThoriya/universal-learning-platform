...
export const PERSONA_OPTIONS: readonly PersonaOption[] = [
  {
    ...
    icon: GraduationCap,
    title: 'Student',
    description: 'Structured learning with academic deadlines',
    longDescription: 'Optimized study schedules that align with school terms and examination periods',
    defaultHours: 6,
    color: 'from-blue-500 to-indigo-500',
    bgColor: 'bg-blue-100',
    textColor: 'text-blue-700',
    benefits: ['Structured learning', 'Academic focus', 'Peer collaboration'],
    challenges: ['Multiple subjects', 'Deadline pressure', 'Social balance'],
  },
  {
