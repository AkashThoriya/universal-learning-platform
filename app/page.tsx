            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-8">
                <div className="flex items-start space-x-4">
                  <div className={
                    'flex-shrink-0 w-12 h-12 bg-gradient-to-br from-blue-500 to-purple-500 ' +
                ...
                <div className="flex items-start space-x-4">
                  <div className={
                    'flex-shrink-0 w-12 h-12 bg-gradient-to-br from-green-500 to-teal-500 ' +
                    'rounded-xl flex items-center justify-center'
                  }>
                ...
                <div className="flex items-start space-x-4">
                  <div className={
                    'flex-shrink-0 w-12 h-12 bg-gradient-to-br from-orange-500 to-red-500 ' +
                    'rounded-xl flex items-center justify-center'
                  }>
                ...
                <div className="glass rounded-2xl p-6 hover:scale-105 transition-transform duration-300">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="w-full bg-slate-200 dark:bg-slate-700 rounded-full h-2">
                      <div className="gradient-primary h-2 rounded-full w-3/4 animate-pulse" />
                    </div>
