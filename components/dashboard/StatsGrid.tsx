  ...
  return (
    ...
    >
      <MobileScrollGrid className="md:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card className={cn("bg-gradient-to-br from-blue-500 to-blue-600 text-white overflow-hidden relative", cardClass)}>
        ...
        <Card className={cn("bg-gradient-to-br from-green-500 to-green-600 text-white overflow-hidden relative", cardClass)}>
          <div className="absolute top-0 right-0 w-20 h-20 bg-white/10 rounded-full -mr-10 -mt-10" />
          <CardHeader className="flex flex-row items-center justify-between pb-2">
        ...
        <Card className={cn("bg-gradient-to-br from-orange-500 to-red-500 text-white overflow-hidden relative", cardClass)}>
          <div className="absolute top-0 right-0 w-20 h-20 bg-white/10 rounded-full -mr-10 -mt-10" />
          <CardHeader className="flex flex-row items-center justify-between pb-2">
        ...
        <Card className={cn("bg-gradient-to-br from-purple-500 to-purple-600 text-white overflow-hidden relative", cardClass)}>
          <div className="absolute top-0 right-0 w-20 h-20 bg-white/10 rounded-full -mr-10 -mt-10" />
          <CardHeader className="flex flex-row items-center justify-between pb-2">
