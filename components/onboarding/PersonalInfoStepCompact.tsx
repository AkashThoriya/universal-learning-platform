          ...
          <div className="space-y-4">
                  ...
                  >
                    <CardContent className="p-4">
                      <div className="flex items-start justify-between">
                        ...
                        {isSelected && <CheckCircle className="h-6 w-6 text-blue-600 ml-2 flex-shrink-0" />}
                      </div>
            ...
            {searchQuery && displayExams.length === 0 && (
              <div className="text-center py-8">
                ...
                <p className="text-gray-600 mb-4">We couldn't find any exams matching "{searchQuery}"</p>
        ...
        <Card className="border-purple-200 bg-gradient-to-r from-purple-50 to-pink-50">
          <CardContent className="p-6">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <Label className="text-lg font-semibold text-purple-800">Custom Exam Details</Label>
            </div>
            <div className="space-y-4">
              <div>
          ...
          <Card className="border-green-200 bg-gradient-to-r from-green-50 via-blue-50 to-purple-50">
            <CardContent className="p-6">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-green-700">
                    ...
                    {selectedExam?.defaultSyllabus && (
                      <span>
                        {' '}
                        We'll start with {selectedExam.defaultSyllabus.length} core subjects that you can customize.
                      </span>
                    )}
                  </p>
                </div>
              ...
              <div className="flex items-center justify-center pt-4 border-t border-green-200 mt-4">
                <Badge className="bg-green-600 text-white px-4 py-2">✨ Ready to organize your syllabus</Badge>
              </div>
            </CardContent>
          </Card>
        )}
