...
export default function StrategyInsights({ user, syllabus, completedTopicsCount }: StrategyInsightsProps) {
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground mt-1">Set your <strong className="text-blue-600">Preparation Start Date</strong> to activate velocity tracking, pace analysis, and projected finish dates.</p>
              </div>
            </div>
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
            ...
            <div className="relative pt-6 pb-2">
                ...
                <div className="space-y-3">
                    <div className="space-y-1">
                        ...
                        <Progress value={metrics.percentageContentCompleted} className="h-2 bg-blue-100" indicatorClassName="bg-blue-600" />
                    </div>
                    <div className="space-y-1">
                         <div className="flex justify-between text-xs">
            ...
            <div className="grid grid-cols-2 gap-4 bg-white/60 rounded-xl p-4 border border-blue-50">
                <div>
                 ...
                 <div>
                    ...
                    <div className="flex items-baseline gap-1 mt-1">
                        <span className={`text-2xl font-bold ${metrics.currentVelocity >= metrics.requiredVelocity ? 'text-emerald-600' : 'text-amber-600'}`}>
      ...
      {/* Projection Card */}
      <Card className={`shadow-md border-l-4 ${metrics.status === 'on_track' || metrics.status === 'ahead' ? 'border-l-emerald-500' : 'border-l-amber-500'}`}>
        <CardHeader>
