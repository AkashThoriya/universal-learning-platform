...
const AnalyticsWidget: React.FC<AnalyticsWidgetProps> = ({ className }) => {
  ...
  const summaryMetrics = useMemo(() => {
    ...
    return {
      ...
      learningEfficiency: {
        current: Math.round(
          (analytics.examPerformance.revisionEffectiveness + analytics.coursePerformance.codingEfficiency) / 2
        ),
    ...
    return (
      <Card className={className}>
        <CardContent className="flex flex-col items-center justify-center py-8">
          ...
          <p className="text-sm text-muted-foreground text-center">{error || 'Analytics data not available yet'}</p>
          <p className="text-xs text-muted-foreground mt-1">Start studying to see your performance insights</p>
        </CardContent>
      </Card>
    );
  }
      ...
      <CardContent className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2">
              <span className="text-2xl font-bold">{summaryMetrics?.learningEfficiency.current}%</span>
          ...
          <div className="space-y-2">
            {analytics.crossTrackInsights.learningTransfer.length > 0 && (
              <div className="p-3 bg-green-50 rounded-lg border border-green-200">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-green-800">Cross-Track Learning Active</p>
            ...
            {analytics.examPerformance.weakAreas.length > 0 && (
              <div className="p-3 bg-orange-50 rounded-lg border border-orange-200">
                <div className="flex items-center justify-between">
                  <div>
                    <p className="text-sm font-medium text-orange-800">Focus Areas Identified</p>
